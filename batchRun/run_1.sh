...
CUDA_VISIBLE_DEVICES=2 CUDA_HOME=$CONDA_PREFIX PYTHONPATH=$(pwd) python -m cosmos_predict1.diffusion.inference.workload.renderingCache2 \
  --checkpoint_dir checkpoints \
  --input_image_path /export/scratch/lvigorel/GEN3C/assets/diffusion/000.png \
  --video_save_folder buffer1/leftcentered/ \
...
CUDA_VISIBLE_DEVICES=2 CUDA_HOME=$CONDA_PREFIX PYTHONPATH=$(pwd) python -m cosmos_predict1.diffusion.inference.workload.renderingCache2 \
  --checkpoint_dir checkpoints \
  --input_image_path /export/scratch/lvigorel/GEN3C/assets/diffusion/000.png \
  --video_save_folder buffer1/rightfixed/ \
  --video_save_name md03g1 \
  --guidance 1 \
  --trajectory right \
...
CUDA_VISIBLE_DEVICES=2 CUDA_HOME=$CONDA_PREFIX PYTHONPATH=$(pwd) python -m cosmos_predict1.diffusion.inference.workload.renderingCache2 \
  --checkpoint_dir checkpoints \
  --input_image_path /export/scratch/lvigorel/GEN3C/assets/diffusion/000.png \
  --video_save_folder buffer1/rightcentered/ \
  --video_save_name md03g1 \
  --guidance 1 \
  --trajectory right \
  --save_buffer \
...
for dist in 1 0.4 0.5 0.6 0.7 0.8; do
  ...
  CUDA_VISIBLE_DEVICES=2 CUDA_HOME=$CONDA_PREFIX PYTHONPATH=$(pwd) python -m cosmos_predict1.diffusion.inference.workload.renderingCache2 \
    --checkpoint_dir checkpoints \
    --input_image_path /export/scratch/lvigorel/GEN3C/assets/diffusion/000.png \
    --video_save_folder buffer1/leftfixed/ \
    --video_save_name $name \
    --guidance 1 \
    $extra \
    --camera_rotation no_rotation \
...
CUDA_VISIBLE_DEVICES=2 CUDA_HOME=$CONDA_PREFIX PYTHONPATH=$(pwd) python -m cosmos_predict1.diffusion.inference.workload.renderingCache2 \
  --checkpoint_dir checkpoints \
  --input_image_path /export/scratch/lvigorel/GEN3C/assets/diffusion/000.png \
  --video_save_folder buffer1/upcentered/ \
  --video_save_name md03g1 \
  --guidance 1 \
  --trajectory up \
  --save_buffer \
